...
|----------|---------------|---------------|
| `AGENTS.md` | `630d377` | `AGENTS.md`, `Makefile`, `start.sh` |
| `.agents/skills/caddy/SKILL.md` | `630d377` | `webui/internal/caddy/`, `webui/internal/handlers/caddy.go` |
| `.agents/skills/socat/SKILL.md` | `630d377` | `webui/internal/socat/`, `webui/internal/handlers/socat.go` |
| `.agents/skills/webui/SKILL.md` | `630d377` | `webui/`, `Makefile` |
| `.agents/skills/docker-ci/SKILL.md` | `630d377` | `Dockerfile`, `.github/workflows/`, `compose-test.yml` |
| `.agents/skills/tailscale/SKILL.md` | `630d377` | `webui/internal/tailscale/`, `start.sh` |
| `webui/README.md` | `630d377` | `webui/` |
| `README.md` | `630d377` | `README.md`, `webui/internal/web/server.go` |
| `.agents/skills/security-review/SKILL.md` | `630d377` | `webui/internal/auth/`, `webui/internal/handlers/`, `webui/internal/caddy/`, `webui/internal/socat/`, `webui/internal/backup/`, `Dockerfile`, `start.sh` |
| `.agents/skills/testing-cicd/SKILL.md` | `630d377` | `tests/`, `webui/internal/*/\*_test.go`, `.github/workflows/ci.yml` |
| `.agents/skills/documentation/SKILL.md` | `630d377` | `README.md`, `CHANGELOG.md`, `webui/README.md`, `AGENTS.md`, `.agents/skills/` |
